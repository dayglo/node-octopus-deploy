...
describe('commands/simple-create-release-and-deploy', () => {
  ...
  const releaseVersion = '1.0.0-rc-3'
  const releaseNotes = 'Battle commencing in 3... 2... 1...'
  const packageVersion = '1.0.0'
  const simpleReleaseParams = { projectSlugOrId: project.slug, releaseVersion, releaseNotes, packageVersion }
  ...
  describe('when project exists', () => {
    ...
    it('creates a release and then deploy that release', () => {
      const releaseParams = { projectId: project.id, releaseVersion, releaseNotes, selectedPackages }
    ...
    describe('when packageVersion is not provided', () => {
      it('uses version as packageVersion', () => {
        ...
        const releaseParams = { projectId: project.id, releaseVersion, releaseNotes, selectedPackages: altPackages }
