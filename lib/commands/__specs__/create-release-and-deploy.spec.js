...
describe('commands/create-release-and-deploy', () => {
  ...
  const releaseParams = { projectId, releaseVersion, releaseNotes, selectedPackages }
  ...
  it('deploys the release', () => {
    const release = createRelease({ projectId, version: releaseVersion, releaseNotes, selectedPackages })
    ...
    const expectedParams = { projectId, version: releaseVersion, releaseNotes, selectedPackages }
